...
export const DEFAULT_CHART: readonly {
  ...
  { code: "1000", name: "Assets", rootType: "ASSET", accountType: "OTHER", isGroup: true },
  { code: "1100", name: "Cash", rootType: "ASSET", accountType: "CASH", isGroup: false, parent: "1000" },
  { code: "1110", name: "Bank", rootType: "ASSET", accountType: "BANK", isGroup: false, parent: "1000" },
  { code: "1200", name: "Accounts receivable", rootType: "ASSET", accountType: "RECEIVABLE", isGroup: false, parent: "1000" },
  { code: "1300", name: "Stock on hand", rootType: "ASSET", accountType: "STOCK", isGroup: false, parent: "1000" },
  { code: "1400", name: "Kitchen equipment", rootType: "ASSET", accountType: "FIXED_ASSET", isGroup: false, parent: "1000" },

  { code: "2000", name: "Liabilities", rootType: "LIABILITY", accountType: "OTHER", isGroup: true },
  { code: "2100", name: "Accounts payable", rootType: "LIABILITY", accountType: "PAYABLE", isGroup: false, parent: "2000" },
  { code: "2200", name: "Tax payable", rootType: "LIABILITY", accountType: "TAX", isGroup: false, parent: "2000" },
  { code: "2300", name: "Wages payable", rootType: "LIABILITY", accountType: "OTHER", isGroup: false, parent: "2000" },

  { code: "3000", name: "Equity", rootType: "EQUITY", accountType: "EQUITY", isGroup: true },
  { code: "3100", name: "Owner's capital", rootType: "EQUITY", accountType: "EQUITY", isGroup: false, parent: "3000" },
  { code: "3200", name: "Retained earnings", rootType: "EQUITY", accountType: "EQUITY", isGroup: false, parent: "3000" },

  { code: "4000", name: "Income", rootType: "INCOME", accountType: "OTHER", isGroup: true },
  { code: "4100", name: "Food sales", rootType: "INCOME", accountType: "INCOME_ACCOUNT", isGroup: false, parent: "4000" },
  { code: "4200", name: "Beverage sales", rootType: "INCOME", accountType: "INCOME_ACCOUNT", isGroup: false, parent: "4000" },
  { code: "4300", name: "Other income", rootType: "INCOME", accountType: "INCOME_ACCOUNT", isGroup: false, parent: "4000" },

  { code: "5000", name: "Expenses", rootType: "EXPENSE", accountType: "OTHER", isGroup: true },
  { code: "5100", name: "Cost of goods sold", rootType: "EXPENSE", accountType: "COST_OF_GOODS_SOLD", isGroup: false, parent: "5000" },
  { code: "5200", name: "Wages", rootType: "EXPENSE", accountType: "EXPENSE_ACCOUNT", isGroup: false, parent: "5000" },
  { code: "5300", name: "Rent", rootType: "EXPENSE", accountType: "EXPENSE_ACCOUNT", isGroup: false, parent: "5000" },
  { code: "5400", name: "Utilities", rootType: "EXPENSE", accountType: "EXPENSE_ACCOUNT", isGroup: false, parent: "5000" },
  { code: "5500", name: "Stock wastage", rootType: "EXPENSE", accountType: "EXPENSE_ACCOUNT", isGroup: false, parent: "5000" },
  { code: "5900", name: "Round off", rootType: "EXPENSE", accountType: "ROUND_OFF", isGroup: false, parent: "5000" },
];
